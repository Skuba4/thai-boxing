...
class RoundScore(models.Model):
    ...
    # Замечания и очки
    remark_fighter_1 = models.CharField(max_length=255, blank=True, null=True)
    remark_fighter_2 = models.CharField(max_length=255, blank=True, null=True)
    points_fighter_1 = models.PositiveIntegerField(blank=True, null=True)
    points_fighter_2 = models.PositiveIntegerField(blank=True, null=True)

    # Выбор победителя раунда
    winner_choice = models.CharField(
        max_length=10,
        choices=[('fighter_1', 'Боец 1'), ('fighter_2', 'Боец 2'), ('draw', 'Ничья')],
        blank=True,
        null=True
    )

    # Дополнительные поля для "ВО", "НК", "НЯ" и т.д.
    vo = models.CharField(max_length=10, blank=True, null=True)
    nk = models.CharField(max_length=10, blank=True, null=True)
    nya = models.CharField(max_length=10, blank=True, null=True)
    otk = models.CharField(max_length=10, blank=True, null=True)
    pbo = models.CharField(max_length=10, blank=True, null=True)
    dsk = models.CharField(max_length=10, blank=True, null=True)
    bns = models.CharField(max_length=10, blank=True, null=True)
    rop = models.CharField(max_length=10, blank=True, null=True)

    # Флаг отправки записки
